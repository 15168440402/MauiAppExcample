...
namespace MauiAppExcample
{
	...
	public class ZxingActivity : FragmentActivity
	{
		...
		public static Android.Views.View CustomOverlayView { get; set; }
		...
		protected override void OnCreate(Bundle bundle)
		{
			...
			//SetContentView(new CameraPreview());
			...
			SupportFragmentManager.BeginTransaction()
				.Replace(MauiAppExcample.Resource.Id.content, scannerFragment, "ZXINGFRAGMENT")
				.Commit();
